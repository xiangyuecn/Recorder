...
,"pF0r:"+ //no args
       "A Vue 3 Fragments compatibility issue has been detected in the current page or component"

//@@zh="。请注意并检查：如果template下存在多个根节点(vue3 multi-root)，尽量在最外面再套一层view来避免兼容性问题。"
,"sQ1d:"+ //no args
       ". Please note and check: If there are multiple root nodes under the template (vue3 multi-root), try to wrap it in a view to avoid compatibility issues."

//@@zh="{1}未正确查询到节点，将使用传入的当前页面或组件this的$el.parentNode作为组件根节点"
,"dX7B:"+ //args: {1}
       "If the node is not found correctly in {1}, the $el.parentNode of the current page or component's this will be used as the component's root node"
...
,"HgPC:"+ //no args
       "Please call RecordApp.UniFindCanvas in the App logic layer (if needed in renderjs, please call Recorder directly as in H5)"
...
,"Q5dv:"+ //args: {1}-{2}
       "The current app is not packaged into the specified native plugin [{1}], attempting to load it [{2}]"
