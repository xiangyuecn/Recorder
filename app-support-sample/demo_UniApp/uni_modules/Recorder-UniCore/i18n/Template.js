...
//@@zh="检测到当前页面或组件可能存在Vue3 Fragments兼容性问题"
//@@en="A Vue 3 Fragments compatibility issue has been detected in the current page or component"
,"pF0r:"+ //no args
       "" /** TODO: translate to your-language **/

//@@zh="。请注意并检查：如果template下存在多个根节点(vue3 multi-root)，尽量在最外面再套一层view来避免兼容性问题。"
//@@en=". Please note and check: If there are multiple root nodes under the template (vue3 multi-root), try to wrap it in a view to avoid compatibility issues."
,"sQ1d:"+ //no args
       "" /** TODO: translate to your-language **/

//@@zh="{1}未正确查询到节点，将使用传入的当前页面或组件this的$el.parentNode作为组件根节点"
//@@en="If the node is not found correctly in {1}, the $el.parentNode of the current page or component's this will be used as the component's root node"
,"dX7B:"+ //args: {1}
       "" /** TODO: translate to your-language **/
...
//@@zh="请在App逻辑层中调用RecordApp.UniFindCanvas（renderjs中如果确实需要，请按H5方式直接调用Recorder）"
//@@en="Please call RecordApp.UniFindCanvas in the App logic layer (if needed in renderjs, please call Recorder directly as in H5)"
,"HgPC:"+ //no args
       "" /** TODO: translate to your-language **/
...
//@@zh="当前App未打包进指定原生插件[{1}]，尝试加载[{2}]"
//@@en="The current app is not packaged into the specified native plugin [{1}], attempting to load it [{2}]"
,"Q5dv:"+ //args: {1}-{2}
       "" /** TODO: translate to your-language **/
