## 1.0.260708（2026-07-08）
适配Recorder 1.3.26070800；增强vue3 multi-root检测和兼容提示；调整原生插件requireNativePlugin多端的加载方式
## 1.0.260427（2026-04-27）
增加鸿蒙App支持。修复vue3 setup组合式写法的子组件中没有$root.$page属性导致无法调用的问题，此版本不管时组合式还是选项式写法的子组件都能正常录音。
