...
<!-- #ifdef APP -->
		<navigator url="page_renderjsWithout" style="display: inline;">
			<button size="mini" type="default">后台录音更稳</button>
		</navigator>
<!-- #endif -->
<!-- #ifdef APP || H5 -->
...
<!-- #ifdef VUE3 -->
		<view>
			<navigator url="vue3ComponentTest/vue3_Page" style="display: inline;">
				<button size="mini" type="default">vue3子组件内可用性测试</button>
			</navigator>
		</view>
<!-- #endif -->
		<view>
...
<!-- #endif -->
	...
	<view style="padding:10px 10px">
		...
		<view style="color:#0ab;font-size:22px;font-weight:bold">
			如需录音功能定制开发，网站、App、小程序、前端后端开发等需求，请加QQ群：①群 781036591、②群 748359095、③群 450721519、④群 1027243616，口令recorder，联系群主（即作者），谢谢~
		</view>
	</view>
	...
	<view style="padding:0 10px">
		...
		<view style="font-size:14px;padding-top:10px">
			...
			<view style="color:#f60">app-uni-support.js文件在uni-app中编译到App平台时仅供测试用（App平台包括：Android App、iOS App、鸿蒙App），<text style="font-weight: bold">不可用于正式发布或商用，正式发布或商用需先联系作者获得授权许可</text>（如何获取授权请阅读Recorder-UniCore组件文档）。</view>
