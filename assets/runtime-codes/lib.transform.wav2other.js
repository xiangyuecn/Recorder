...
2026-06-28 wav头处理已封装到了 Recorder.wav_decode 中。
******************/

//=====wav转其他格式核心函数==========
Recorder.Wav2Other=function(newSet,wavBlob,True,False){
	if(!Recorder.wav_decode){ False&&False("需要导入wav.js"); return; };
	Recorder.wav_decode(wavBlob, function(pcm,sampleRate,wavInfo){
		console.log("wav info",sampleRate,wavInfo);
