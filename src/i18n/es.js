...
,"RiWe:"+ //args: {1}-{2}
       "Nota: Si {1} no está configurado, el navegador puede habilitar automáticamente la cancelación de eco (incluida la supresión de ruido); si la cancelación de eco no está deshabilitada, puede causar que: la apertura de la ventana de grabación tarde mucho tiempo (deshabilitarla hará que se abra más rápido), el volumen de reproducción del sistema en dispositivos móviles disminuya (esto se puede restaurar después de cerrar la grabación), el volumen de grabación sea muy bajo o fluctúe, y solo proporcione una transmisión de audio con una frecuencia de muestreo de 16 kHz (deshabilitarla proporcionará una transmisión de alta calidad de 48 kHz); consulte la configuración en {2} de la documentación"
...
,"bM6i:"+ //no args
       "Nota: Imprimir datos binarios como buffers en onProcess y tener algunas WebViews ejecutándose en segundo plano con restricciones puede causar interrupciones"
...
,"jXp3:"+ //no args
       "Los archivos WAV en formato wav raw pcm que no sean mono o estéreo no son compatibles con la decodificación"
